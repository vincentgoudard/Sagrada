...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 626.75, 60.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 906.0, 356.5, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 734.75, 78.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "tanh~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 674.0, 51.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "abs~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1097.0, 139.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1027.0, 507.0, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 841.0, 132.0, 223.0, 22.0 ],
					"style" : "",
					"text" : "gen~ @gen sagrada.debounceclick.gendsp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1133.0, 64.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "!/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1021.0, 46.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1011.0, 88.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1274.0, 279.0, 130.0, 130.0 ],
					"range" : [ -0.01, 0.01 ],
					"style" : "",
					"trigger" : 1,
					"triglevel" : 0.005
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 823.0, -10.439941, 37.0, 22.0 ],
					"style" : "",
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 950.0, 17.560059, 114.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 841.0, 98.5, 56.0, 22.0 ],
					"style" : "",
					"text" : "clip~ 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 841.0, 60.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "delta~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 946.0, 185.5, 130.0, 130.0 ],
					"range" : [ -0.01, 0.01 ],
					"style" : "",
					"trigger" : 1,
					"triglevel" : 0.005
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 841.0, 27.0, 58.0, 22.0 ],
					"style" : "",
					"text" : ">~ 0.001"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1065.5, 321.0, 130.0, 130.0 ],
					"range" : [ -0.1, 0.1 ],
					"style" : "",
					"trigger" : 1,
					"triglevel" : 0.001
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 368.0, 66.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "*~ 10."
								}
...
,
					"patching_rect" : [ 664.25, 121.5, 131.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"name" : "sagrada.debounceclick.gendsp",
				"bootpath" : "~/Documents/Max/Packages/lam-lib/patchers",
				"patcherrelativepath" : "../../../../Max/Packages/lam-lib/patchers",
				"type" : "gDSP",
				"implicit" : 1
