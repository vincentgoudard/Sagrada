...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 245.0, 119.0, 20.0 ],
					"presentation_rect" : [ 224.0, 245.0, 119.0, 20.0 ],
					"style" : "",
					"text" : "duration (half-decay)"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "sagrada.decaysine~ myContext @out pan.in"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 493.5, 439.0, 38.0 ],
					"presentation_linecount" : 2,
					"presentation_rect" : [ 224.0, 493.5, 439.0, 38.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 350.0, 350.0, 41.0, 22.0 ],
					"presentation_rect" : [ 350.0, 350.0, 41.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 131.0, 378.5, 238.0, 22.0 ],
					"presentation_rect" : [ 131.0, 378.5, 238.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.5, 345.0, 89.0, 22.0 ],
					"presentation_rect" : [ 115.5, 345.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "Grain output"
				}
...
,
					"patching_rect" : [ 350.0, 415.0, 50.0, 22.0 ],
					"presentation_rect" : [ 350.0, 415.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 131.0, 415.0, 50.0, 22.0 ],
					"presentation_rect" : [ 131.0, 415.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.000031, 415.0, 83.0, 22.0 ],
					"presentation_rect" : [ 190.000031, 415.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "loadmess -24"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 131.0, 450.5, 238.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 498.0, 45.0, 45.0 ],
					"presentation_rect" : [ 131.0, 498.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.5, 345.0, 414.5, 99.0 ],
					"presentation_rect" : [ 115.5, 345.0, 414.5, 99.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 195.25, 492.75, 166.5, 492.75 ],
					"source" : [ "obj-80", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 140.5, 492.75, 140.5, 492.75 ],
					"source" : [ "obj-80", 0 ]
				}
