...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 546.0, 127.0, 50.0, 22.0 ],
					"presentation_rect" : [ 546.0, 127.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 469.0, 127.0, 24.0, 24.0 ],
					"presentation_rect" : [ 469.0, 127.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 469.0, 156.0, 41.0, 22.0 ],
					"presentation_rect" : [ 469.0, 156.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 221.0, 130.0, 130.0 ],
					"presentation_rect" : [ 469.0, 221.0, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 230.0, 45.0, 45.0 ],
					"presentation_rect" : [ 304.0, 230.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 157.0, 127.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 157.0, 156.0, 64.0, 22.0 ],
					"presentation_rect" : [ 157.0, 156.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 80.0, 127.0, 24.0, 24.0 ],
					"presentation_rect" : [ 80.0, 127.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 156.0, 41.0, 22.0 ],
					"presentation_rect" : [ 80.0, 156.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 221.0, 130.0, 130.0 ],
					"presentation_rect" : [ 80.0, 221.0, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "LAM.clickramp~", "@obj-desc", "Signal-triggered ramp." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
